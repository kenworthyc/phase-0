...
I ran into trouble with creating an object within an object not using the literal
constructor, because I didn't know the syntax. (I also now realize that we could
use the literal constructor for the carson/carter/colton objects! Oh well.) I
relearned the familiar rule to make an empty set before adding to it.

// How difficult was it to add and delete properties outside of the object itself?
Not difficult, but I'll have to remember that deleting requires the 'delete'
function before the call to the correct object and property (whereas adding
involves assigning a value to the call).

// What did you learn about manipulating objects in this challenge?
I practiced the syntax, both the dot constructor and the bracket constructor, for
accessing properties of objects. How properties that are passed in as strings are
converted into non-strings— that fact was solidified for me.
